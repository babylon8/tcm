          ...
          <header className="border-b bg-white/70 backdrop-blur-md sticky top-0 z-50 shadow-sm">
            <div className="container mx-auto px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-display font-semibold text-xl text-ink-900 hidden sm:block">TCM Health</span>
              </div>
              <nav className="flex items-center gap-5 sm:gap-6">
                <a href="/" className="text-sm font-medium text-ink-700 hover:text-sage-600 transition-colors">
                  Home
                </a>
                <a href="/assessment/constitution" className="text-sm font-medium text-ink-700 hover:text-sage-600 transition-colors">
                  Assessment
                </a>
                <a href="/education" className="text-sm font-medium text-ink-700 hover:text-sage-600 transition-colors">
                  Education
                </a>
              </nav>
            </div>
